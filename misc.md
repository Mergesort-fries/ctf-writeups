...
<div class="page-hero">
  <h1 style="color:var(--accent2)">[misc]</h1>
  <p>General skills, encoding challenges, OSINT, and everything else.</p>
</div>

<div class="section-label">misc writeups</div>

<ul class="post-list">
  {% assign misc_posts = site.categories.misc %}
      ...
      <a href="{{ post.url | relative_url }}">
        ...
        <div class="post-body">
          <div class="post-meta-row">
            ...
            <span class="post-tag tag-misc">misc</span>
